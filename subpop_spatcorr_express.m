function [spatcorrs,radfuncs,parms,h,skipflag] = subpop_spatcorr_express(data,popAid,popBid,magA,magB,allcores)
    ...
    for i = 1:numel(allcores)
        ...
        f = fit(radfuncs{i}',spatcorrs{i}','exp1','StartPoint',[0,0]);
